...
CREATE TABLE IF NOT EXISTS `warehouse`.`products` (
  ...
  CONSTRAINT `fk_products_product_category_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_products_room_id`
    FOREIGN KEY (`room_id`)
...
-- -----------------------------------------------------
-- Table `warehouse`.`room_has_shelves`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `warehouse`.`room_has_shelves` (
  `room_id` INT UNSIGNED NOT NULL,
  `shelf_id` INT UNSIGNED NOT NULL,
  INDEX `fk_room_id_idx` (`room_id` ASC) VISIBLE,
  INDEX `fk_shelf_id_idx` (`shelf_id` ASC) VISIBLE,
  CONSTRAINT `fk_room_has_shelves_room_id`
    FOREIGN KEY (`room_id`)
    REFERENCES `warehouse`.`rooms` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_room_has_shelves_shelf_id`
    FOREIGN KEY (`shelf_id`)
    REFERENCES `warehouse`.`shelves` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
