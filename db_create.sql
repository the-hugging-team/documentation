...
CREATE TABLE IF NOT EXISTS `cella`.`invoices` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `company_one_id` INT UNSIGNED NOT NULL,
  `company_two_id` INT UNSIGNED NOT NULL,
  ...
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_created_by_idx` (`created_by` ASC) VISIBLE,
  INDEX `fk_invoices_company_one_id_idx` (`company_one_id` ASC) VISIBLE,
  INDEX `fk_invoices_company_two_id_idx` (`company_two_id` ASC) VISIBLE,
  CONSTRAINT `fk_invoices_created_by`
    FOREIGN KEY (`created_by`)
    REFERENCES `cella`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_invoices_company_one_id`
    FOREIGN KEY (`company_one_id`)
    REFERENCES `cella`.`companies` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_invoices_company_two_id`
    FOREIGN KEY (`company_two_id`)
    REFERENCES `cella`.`companies` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cella`.`deliveries` (
  ...
  INDEX `fk_deliveries_transaction_id_idx` (`transaction_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_deliveries_invoice_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_deliveries_transaction_id`
    FOREIGN KEY (`transaction_id`)
    REFERENCES `cella`.`transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cella`.`sales` (
  ...
  INDEX `fk_sales_transaction_id_idx` (`transaction_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `cella`.`notification_templates`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cella`.`notification_templates` ;

CREATE TABLE IF NOT EXISTS `cella`.`notification_templates` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `cella`.`notification_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cella`.`notification_types` ;

CREATE TABLE IF NOT EXISTS `cella`.`notification_types` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `slug` VARCHAR(45) NOT NULL,
  `notification_template_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_notification_type_notification_template_id_idx` (`notification_template_id` ASC) VISIBLE,
  CONSTRAINT `fk_notification_type_notification_template_id`
    FOREIGN KEY (`notification_template_id`)
    REFERENCES `cella`.`notification_templates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cella`.`role_has_notification_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cella`.`role_has_notification_type` ;

CREATE TABLE IF NOT EXISTS `cella`.`role_has_notification_type` (
  `role_id` INT UNSIGNED NOT NULL,
  `notification_type_id` INT UNSIGNED NOT NULL,
  INDEX `fk_role_has_notification_type_role_id_idx` (`role_id` ASC) VISIBLE,
  INDEX `fk_role_has_notification_type_notification_type_id_idx` (`notification_type_id` ASC) VISIBLE,
  CONSTRAINT `fk_role_has_notification_type_role_id`
    FOREIGN KEY (`role_id`)
    REFERENCES `cella`.`roles` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_role_has_notification_type_notification_type_id`
    FOREIGN KEY (`notification_type_id`)
    REFERENCES `cella`.`notification_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cella`.`notifications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cella`.`notifications` ;

CREATE TABLE IF NOT EXISTS `cella`.`notifications` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `notification_template_id` INT UNSIGNED NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
  `created_at` TIMESTAMP NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_notifications_notification_template_id_idx` (`notification_template_id` ASC) VISIBLE,
  INDEX `fk_notifications_user_id_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_notifications_notification_template_id`
    FOREIGN KEY (`notification_template_id`)
    REFERENCES `cella`.`notification_templates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
